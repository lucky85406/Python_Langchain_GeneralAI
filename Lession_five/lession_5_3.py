...
class ChatModelsManager:
    ...
    def chat(self, user_input: str, model_name: str = "") -> str:
        """進行對話"""
        ...
        try:
            # 建立訊息列表
            messages: List[Any] = [SystemMessage(content=self.system_message)]
